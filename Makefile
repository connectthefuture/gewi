...
gewi.a: $(GEWI_CORE_OBJ) $(GEWI_RENDER_OBJ) $(GEWI_LAYOUT_OBJ) $(GEWI_INTERACTION_OBJ)
	ar r $@ $^ -s
clean:
	rm -rf *.o utils.a gewi.a $(UTILS_OBJ) $(GEWI_CORE_OBJ) $(GEWI_RENDER_OBJ) $(GEWI_LAYOUT_OBJ) $(GEWI_INTERACTION_OBJ)